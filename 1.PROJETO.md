...
- [Parte A - Requisitos](#parte-a---requisitos)
- [Parte B - Modelagem](#parte-b---modelagem)
- [Parte C - Implementação](#parte-c---implementação)
- [Parte D - Testes](#parte-d---testes)
- [Parte E - Consultas](#parte-e---consultas)

### Arquivos Complementares

- [Modelo SQL](modelo.sql)
- [Diagrama (DrawDB)](diagrama.jpeg)
- [Questões](2.Questões.md)
- [Questões Finais](3.Questões%20Finais.md)
- [Autoavaliação](4.Autoavaliação.md)
...
![Diagrama do Modelo Lógico](diagrama.jpeg)
...
O script completo de criação do banco de dados, incluindo tabelas, constraints e dados fictícios utilizados no projeto, encontra-se no arquivo abaixo:

[Abrir modelo.sql](modelo.sql)
